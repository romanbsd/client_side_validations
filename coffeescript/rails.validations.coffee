...
ClientSideValidations =
  ...
  enablers:
    form: (form) ->
      ...
      form.ClientSideValidations =
        settings: ClientSideValidations.forms[$form.attr('id')]
  ...
  remote_validators_url_for: (validator) ->
  ...
  disableValidators: () ->
    return if ClientSideValidations.disabled_validators == undefined
    for validator, func of ClientSideValidations.validators.remote
      if validator in ClientSideValidations.disabled_validators
        delete ClientSideValidations.validators.remote[validator]
